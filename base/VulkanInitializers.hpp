/*
* Initializers for Vulkan structures and objects used by the exampeles
* Saves lot of VK_STRUCTURE_TYPE assignments
* Some initializers are also parameterized
* 
* Based off of Sascha Willems' project: https://github.com/SaschaWillems/Vulkan
*/

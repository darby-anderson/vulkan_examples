...
namespace puffin {
    ...
    #define p_print(format, ...)     puffin::LogService::instance()->print_format(format, ## __VA_ARGS__);
    #define p_printret(format, ...)  puffin::LogService::instance()->print_format(format, ## __VA_ARGS__); puffin::LogService::instance()->print_format("\n");
}